...
import { Search, Play, Trophy, Clock, Loader2, BookOpen, Star, Users, Award } from 'lucide-react';
import CourseCard from './CourseCard'; // Make sure this import is present
...
export default function CoursesSection({
  ...
  const trendingCourses = [
    ...
    },
    {
      ...
      rating: 4.7,
      students: 8900,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/2920/2920197.png'
    },
    {
      id: 'uiux301',
    ...
    },
    {
      ...
      rating: 4.5,
      students: 18300,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/2942/2942704.png'
    },
    {
      id: 'ds501',
    ...
    },
    {
      ...
      category: 'Technology',
      description: 'Understand blockchain technology, smart contracts, and cryptocurrency trading.',
      progress: 0,
      level: 'Intermediate',
      duration: '6 weeks',
      rating: 4.4,
      students: 7200,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/825/825454.png'
    },
    {
      id: 'cy401',
    ...
    },
    {
      ...
      rating: 4.6,
      students: 16700,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/4712/4712139.png'
    },
    {
      id: 'pm301',
    ...
    },
    {
      ...
      category: 'Data Science',
      description: 'Master data analysis, visualization, and database querying for business insights.',
      progress: 0,
      level: 'Beginner',
      duration: '5 weeks',
      rating: 4.4,
      students: 21200,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/888/888874.png'
    },
    {
      id: 'cc401',
      ...
      rating: 4.8,
      students: 8900,
      imageUrl: 'https://cdn-icons-png.flaticon.com/512/873/873120.png'
    }
  ];
    ...
    <div className="space-y-8">
      ...
      {!curriculum && searching && (
        <div className="text-center py-20">
          ...
          <p className="text-gray-500">This might take a moment as AI searches for the best resources.</p>
        </div>
      )}
